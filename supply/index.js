...
class Index extends Component {
    ...
    GET_TitleEditBtn = arg => {
        ...
        return <div className="RT">
            ...
            <label>版本：<Select defaultValue={this.state.versionData.length ? this.state.versionData[0]["id"] : ""}
                              className="ipt120">{Options()}</Select></label>
        </div>
    };
                ...
                <Tabs defaultActiveKey="1">
                    <TabPane tab="供货" key="1" tabBarExtraContent={this.GET_Compent}>
                        <article>
                            ...
                            <TableBar dataSource={this.state.dataSource} columns={this.state.columns}
                        ...
                        <article>
                            <header className="HeaderBar"><Row>
                                ...
                                <Col span={12}>
                                    <div className="RT">
                                        <button className="jh_btn jh_btn22 jh_btn_edit" onClick={this.handleEdit}>
                                            编辑供货
                                        </button>
                                    </div>
                                </Col>

...
class Index extends Component {
        ...
        EditInput = (val,key,column) => {
            ...
            if(this.state.editstatu){
                return (
                    <div>
                        {<Input style={{ margin: '-5px 0' }} type="text" defaultValue={val} onChange={e => this.handleChange(e.target.value,key,column)} />}
                    </div>
                )
            }else{
                return val
        ...
        paymentTable = () => {
            ...
            return (
                <div className="tableBox">
                    <Table columns={this.columns} pagination={false} bordered scroll={{ x:this.scrollWidth, y:"100%" }} dataSource={this.state.data} />
                </div>
                        ...
                        <h3 className="boxGroupTit">
                            ...
                            <div>
                                <div className="areaTopbtn jhBtn-wrap">
                                    <button type="button" className="jh_btn jh_btn22 jh_btn_add" onClick={this.cancalClick.bind(this)}>取消</button>
                                    <button type="button" className="jh_btn jh_btn22 jh_btn_add" onClick={this.saveClick.bind(this)}>保存</button>
                ...
                return (
                    <div>
                        ...
                        <h3 className="boxGroupTit">
                            ...
                            <div>
                                <div className="areaTopbtn jhBtn-wrap">
                                    <button type="button" className="jh_btn jh_btn22 jh_btn_add" onClick={this.editClick.bind(this)}>编辑</button>
                                    <button type="button" className="jh_btn jh_btn22 jh_btn_apro credit-card">版本</button>
                                    <button className="">{this.tableSelect()}</button>
                                </div>
                            </div>

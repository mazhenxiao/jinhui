...
class Province extends React.Component {
    ...
    province(p,c,t){
        var th = this;
        var province=p,city=c,town=t;
        for(var i=0;i<th.provinceList.length;i++){
            addEle(province,th.provinceList[i].name);
        }
        ...
        function removeEle(ele){
            ...
            var optionStar="<option value="+""+">"+""+"</option>";
            ele.append(optionStar);
        }
        var provinceText,cityText,cityItem;
        province.on("change",function(){
            provinceText=$(this).val();
            $.each(th.provinceList,function(i,item){
            ...
            removeEle(city);
            removeEle(town);
            $.each(th.provinceList[cityItem].cityList,function(i,item){
    ...
    componentDidMount() {
        this.province($(`#${this.props.province}`),$(`#${this.props.city}`),$(`#${this.props.town}`));
    }
    render() {
      return  <section>
            <select className="levelStyle" name="province" id={this.props.province} multiple="multiple">
                <option value=""></option>
            </select>
            <select className="levelStyle" name="city" id={this.props.city} multiple="multiple">
                <option value=""></option>
            </select>
            <select className="levelStyle" name="town" id={this.props.town} multiple="multiple">
                <option value=""></option>
            </select>
        </section>
    }

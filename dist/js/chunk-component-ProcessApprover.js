...
var _componentNewProjectApproverNode = __webpack_require__(659);
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        "div",
                        { className: "mgT10" },
                        _react2.default.createElement(_componentNewProjectApproverNode2.default, { guid: this.state.guid, data: this.state.textarea })
                    )
                )
            );
        }
...
var ApprovalControlNode2 = function (_React$Component) {
    ...
    _createClass(ApprovalControlNode2, [{
        ...
        value: function componentWillMount() {
            ...
            this.GetJurisdiction(function (arg) {
                var da = arg.d;
                if (da.Success) {
                    th.setState({
                        type: true,
        ...
        value: function changeAOinions(event) {
            ...
            var th = this;
            this.setState({ aOpinions: event.target.value }, function (arg) {
        ...
        value: function BIND_CHECKEDIT() {
            if (this.state.type) {
                return _react2.default.createElement(
                    "p",
                    { className: "btnBox" },
                    this.state.mainData.indexOf("Approve") >= 0 && _react2.default.createElement(
                        "a",
                        { className: "btn", href: "javascript:;", onClick: this.EVENT_CLICK_PASS.bind(this) },
                        "\u901A\u8FC7"
                    ),
                    this.state.mainData.indexOf("Return") >= 0 && _react2.default.createElement(
                        "a",
